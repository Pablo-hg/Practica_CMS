<div class="hilo">
    <?php foreach ($datos as $row){ ?>
        <div class="cajita">
            <aside>
                <img src="<?php
                echo $_SESSION['public']."img/".$row->image
                ?>" alt="perfil" class="circle">
    ...
    <div class="btn waves-effect waves-light" style="margin-left: 28%">
        ...
        <?php } else { ?>
            <button class="btn waves-effect waves-light" type="submit" name="responder" style="margin: 35px 42.5%;" >Responder
